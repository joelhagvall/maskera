...
PY=.venv/bin/python
echo "[1/5] finetune student-v6 from student-v5 (epochs ${EPOCHS:-2}, lr ${LR:-1e-5})..."; $PY finetune_student.py student-v5 student-v6 "${EPOCHS:-2}" "${LR:-1e-5}" >/dev/null 2>&1
echo "[2/5] trim vocab..."; $PY trim_vocab.py student-v6 student-v6-trimmed 16000
echo "[3/5] export onnx..."; rm -rf student-v6-onnx; $PY export_onnx.py student-v6-trimmed student-v6-onnx
echo "[4/5] q4 combo..."; $PY quantize_combo.py student-v6-onnx
echo "[5/5] eval..."
