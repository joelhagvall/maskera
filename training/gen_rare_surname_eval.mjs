...
const CANDIDATES = [
  "Tjulander", "Tjernström", "Tibblin", "Tegmark", "Tingsten", "Torekull",
  "Troedsson", "Themptander", "Thorvaldsson", "Trolle", "Uddenberg", "Uggla",
  "Ulvskog", "Unckel", "Uvnäs", "Vennberg", "Vinterhed", "Wachtmeister",
  "Wallquist", "Wetterstrand", "Wigforss", "Wijkman", "Wirsén", "Wästberg",
  "Zennström", "Åkerhielm", "Ängquist", "Öhrström", "Örtendahl", "Almroth",
  "Alsterlund", "Ankarberg", "Backelin", "Bexelius", "Billström", "Bjurström",
  "Blidberg", "Brandell", "Brogren", "Brynolf", "Bäckdahl", "Cavallin",
  "Cederlöf", "Cedervall", "Delblanc", "Duvander", "Edfeldt", "Ekedahl",
  "Ekelöf", "Elfstrand", "Elmlund", "Enocksson", "Fagerlind", "Fahlgren",
  "Fjellman", "Flodberg", "Fogelklou", "Forslid", "Frostenson", "Fägerquist",
  "Gadelius", "Granlycke", "Grönblad", "Gyllenhammar", "Gyllensten",
  "Hagströmer", "Hallonsten", "Hasselrot", "Hedenblad", "Hellspong",
  "Hildingsson", "Hjertén", "Holmertz", "Hultkrantz", "Husmark", "Hyltenstam",
  "Häggroth", "Högfeldt", "Idermark", "Ingelman", "Jerneck", "Jonzon",
  "Kindblom", "Kjellander", "Klingspor", "Kolmodin", "Kullenberg", "Kyhlberg",
  "Lagercrantz", "Leijonborg", "Lidbeck", "Liljencrantz", "Lindeblad",
  "Munkhammar", "Myrdal", "Månberg", "Nauclér", "Nyrén", "Ohlander",
  "Orrenius", "Palmcrantz", "Quennerstedt", "Ramel", "Reenstierna",
  "Rehnberg", "Reuterswärd", "Ribbing", "Rosenblad", "Rudbeck", "Runefelt",
  "Rådström", "Rönnlund", "Sahlgren", "Sandelin", "Segerfeldt", "Silfverberg",
  "Sommarström", "Sparrman", "Stagnelius", "Stenudd", "Stiernstedt", "Stolpe",
  "Strandhäll", "Sundelius", "Säfström", "Tegnér", "Kallifatides",
  "Mannerheim", "Melldahl", "Millgård", "Mogensen", "Hammarlind", "Ehrnrooth",
]
...
for (let i = 0; i < kept.length; i++) {
  ...
  for (let k = 0; k < PER_NAME; k++) {
    ...
    const form = tpl.c === "lower" ? name.toLowerCase() : tpl.c === "caps" ? name.toUpperCase() : name
