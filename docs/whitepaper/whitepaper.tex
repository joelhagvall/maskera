...
\date{July 19, 2026 \quad\textperiodcentered\quad Whitepaper v1.12}
...
All numbers below were measured on \textbf{2026-07-19} against the published
artifact (\pkg{maskera@0.6.4}, q4 quantisation, the v18 training round) using
...
35} addresses (\emph{Sveavägen 44}, not just \emph{Sveavägen}). The
previous release's one documented exception (the ordinary word \emph{Festen}
over-redacted in one distractor sentence) is fixed in this release, which
...
\begin{itemize}
  ...
  \item \textbf{The model:} published openly on Hugging Face
        ...
        {\footnotesize\texttt{110442cc1143e0543f41a5b111c22af34b0bba9d5c30758b4824d9aa114ac5f4}};\\
...
``L\"ofven \"ar gift med kyrkopolitikern (S) Ulla L\"ofven sedan 2003.''
& L\"ofven & PER & sentence-initial bare surname in declarative prose; the
full name \emph{Ulla L\"ofven} is caught \\
\bottomrule
\end{tabular}
\end{table}

The metonymic ``Vita huset'', fixed in v11, regressed back in v13 and
stays. The bare-``L\"ofven'' declarative miss is new in v18 and was weighed
explicitly in the publish decision: it is the documented bare-surname
declarative residue surfacing once in cased form, on the axis the dedicated
294-sentence rare-surname eval measures at its best value ever. In exchange
v15's \emph{Festen} over-redaction is fixed and the release carries no gate
exception. Historically: bare ``L\"ofven'' in chat frames and the all-caps
...
forced lowercase, now 53 of 58 covered, the best measured) were fixed by
v15's balanced class replay and improved again by v18; see
\pkg{BENCHMARKS.md}. These misses
...
{\footnotesize\raggedright maskera \textperiodcentered{} whitepaper v1.12
