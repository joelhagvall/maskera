...
\date{July 20, 2026 \quad\textperiodcentered\quad Whitepaper v1.13}
...
artifact (\pkg{maskera@0.6.5}, whose \pkg{reconstruct()} code is unchanged
since 0.6.3; q4 quantisation, the v18 training round) using
...
As of the artifact above, two gold entities have no overlapping detection
(genuine misses) and no ordinary word is over-redacted; the misses are
published here deliberately, and in each sentence every other real entity
is caught. Provenance: both sentences are verbatim, already-published
Wikipedia prose about public figures. No user data and no real private
persons appear below.
...
{\footnotesize\raggedright maskera \textperiodcentered{} whitepaper v1.13
\textperiodcentered{} July 20, 2026 \textperiodcentered{} Joel H\"agvall
