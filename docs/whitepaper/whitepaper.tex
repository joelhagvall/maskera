...
downloads the static model once from a public host; a self-hosted model
makes zero external requests. Measured on a small independent Swedish gold set, the
...
known exceptions are in \pkg{BENCHMARKS.md}. One known exception is reported
...
{\footnotesize\raggedright maskera \textperiodcentered{} whitepaper v1.4
