...
\date{August 6, 2026 \quad\textperiodcentered\quad Whitepaper v1.16}
...
The public-model comparison tables below were measured on \textbf{2026-07-19}
against historical v18 and \pkg{maskera} version \pkg{0.6.4}. Its \pkg{reconstruct()} code is
unchanged since 0.6.3; the measurements use q4 quantisation from v18 and
...
runtime passed every defined release gate. The published artifact is
...
LinkedIn-style (53) & 74.6\% & 88.7\% & 81.0\% & 77.6\% & 0 \\
\bottomrule
\end{tabular}
\end{table}
...
\pkg{7ecd7a531c989d09ffb3d9ecf4168696786a204e}.
...
\subsection{External gold corpus (directional floor)}
...
{\footnotesize\raggedright maskera \textperiodcentered{} whitepaper v1.16
\textperiodcentered{} August 6, 2026 \textperiodcentered{} Joel H\"agvall
