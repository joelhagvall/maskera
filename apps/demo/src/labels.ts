...
const MAP: Record<string, LabelMeta> = {
  ...
  ADRESS: { sv: "Adress", color: "#b8420a" }, // orange (kept apart from ORGANISATION's brown by lightness, measured)
  POSTNUMMER: { sv: "Postnummer", color: "#3f6212" }, // lime
  LAGENHETSNUMMER: { sv: "Lägenhetsnr", color: "#065f46" }, // emerald
  // organisations
  ORGANISATION: { sv: "Organisation", color: "#713f12" }, // dark brown
  ...
  EPOST: { sv: "E-post", color: "#0369a1" }, // sky blue (kept apart from TELEFON's teal, measured)
